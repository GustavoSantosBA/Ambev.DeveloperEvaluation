...
public class SalesController : BaseController
{
    ...
    public async Task<IActionResult> CreateSale([FromBody] CreateSaleRequest request, CancellationToken cancellationToken)
    {
        ...
        // FIX: Catch the specific exception for duplicate sale numbers.
    ...
    /// <summary>
    /// Retrieves sales with pagination and filtering
    /// </summary>
    /// <param name="request">The sales query request with pagination and filters</param>
    /// <param name="cancellationToken">Cancellation token</param>
    ...
    public async Task<IActionResult> UpdateSale([FromRoute] Guid id, [FromBody] UpdateSaleRequest request, CancellationToken cancellationToken)
    {
        ...
        catch (InvalidOperationException ex) when (ex.Message == "Cannot update a cancelled sale")
        {
            return BadRequest(new ApiResponse
            {
                Success = false,
    ...
    {
        var request = new CancelSaleItemRequest { SaleId = saleId, ProductId = productId };
